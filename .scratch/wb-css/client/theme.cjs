...
exports.TOKEN_BLOCK = exports.STYLE_ID = void 0;
exports.installFeatureStyles = installFeatureStyles;
 ...
 */
exports.STYLE_ID = 'dsh-im-companion-styles';
exports.TOKEN_BLOCK = `
...
function installTag(styleId, css) {
    ...
    try {
        ...
        return () => { try {
            ...
            if (cur && cur.getAttribute?.('data-gen') === String(gen))
                cur.remove();
        }
        catch { } };
    }
...
function installFeatureStyles(id, css) {
    return installTag('af-feature-' + id, css);
}
/** 安装全局样式（幂等，热重载安全）；返回清理函数。 */
function installStyles() {
    return installTag(exports.STYLE_ID, CSS);
}
