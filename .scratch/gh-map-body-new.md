...
- [A1 红线收编 · panel.ts 342 行拆分至 ≤300（示范拆分范式）](https://github.com/FeatherHunter/dsh-im-companion/issues/5)（2026-09-02 交付）：panel.ts 342→92 行，职责三拆（panel-data 状态 / panel-body 渲染 / panel-actions 动作）+ 编排器；17/17 验证与类型检查绿，src 全绿 ≤300。

- [T0 · 300 行红线守卫 + 构建管线加固](https://github.com/FeatherHunter/dsh-im-companion/issues/16)（2026-09-03 交付）：tools/guard/check-lines.mjs 机械守卫 + npm run check 一键门禁（build+typecheck+verify+guard 全绿，30 文件 max 276 行）。
...
下一步：认领 A 线 B1（#6，奠基）或 AFK 票 #5；F0/R5 已决、子议题关联已修复（14/14）。
