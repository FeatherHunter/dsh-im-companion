...
.b3-header-pop { ${TOKEN_BLOCK} position: absolute; top: calc(100% + 8px); right: 0; z-index: 1200; width: 280px; background: var(--af-surface-2); border: 1px solid var(--af-hairline-strong); border-radius: 14px; box-shadow: 0 12px 32px rgba(0, 0, 0, .25); color: var(--af-primary); font-family: -apple-system, "SF Pro Text", "PingFang SC", sans-serif; padding: 12px; font-size: 12px; line-height: 18px; } .b3-header-title { font-size: 13px; font-weight: 700; margin-bottom: 2px; } .b3-header-sub { color: var(--af-secondary); margin-bottom: 8px; word-break: break-all; } .b3-header-row { display: flex; gap: 8px; } .b3-header-channels { display: grid; gap: 5px; margin-bottom: 8px; } .b3-header-chrow { display: flex; align-items: center; gap: 7px; font-size: 12px; } .b3-header-chbadge { width: 18px; height: 18px; flex: none; border-radius: 6px; display: inline-grid; place-items: center; color: #fff; font-size: 11px; font-weight: 700; }
