...
'.c1a-route{padding:6px 0;border-bottom:1px solid var(--dsw-alias-separator,#eee)}',
'.c1a-rchat{font-size:12px;word-break:break-all}',
'.c1a-rlow{display:flex;align-items:center;gap:10px;margin-top:3px}',
'.c1a-rlow code{font-size:11px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;flex:1;min-width:0;word-break:break-all}',
