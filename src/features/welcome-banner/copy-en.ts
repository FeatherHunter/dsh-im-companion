...
export const PH_EN: Record<TimeSeg, SegDefEn> = {
  wee: { tab: "Wee", sky: "wb-sky-wee", moon: true, horizon: true, opts: [
    { t: "Still up? I saved you a light", s: "Online · The whole world is asleep—except us", b: "Home", bs: "Cold out, warm inside" },
    { t: "Almost dawn—I'll wait it out with you", s: "Online · Insomnia or overtime, I'm on shift", b: "Home", bs: "A little longer" },
  ...
  dawn: { tab: "Dawn", sky: "wb-sky-dawn", moon: false, horizon: false, opts: [
    { t: "Morning—I'm already up", s: "Online · Have something hot first", b: "Home for breakfast", bs: "Porridge's on" },
  ...
  day: { tab: "Day", sky: "wb-sky-day", moon: false, horizon: false, opts: [
    ...
    { t: "Loud out there, quiet in here", s: "Online · 1 session waiting", b: "Home", bs: "Come sit quiet" },
  ] },
