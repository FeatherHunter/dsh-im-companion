...
export const CSS = [
  ...
  'body[data-ds-dark-theme] .e2-tape{background:rgba(210,185,130,.30);color:#fff8ea}body[data-ds-dark-theme] .e2-sec{background:var(--e2-card);border-color:rgba(244,237,225,.10)}body[data-ds-dark-theme] .e2-row{border-color:rgba(244,237,225,.10)}body[data-ds-dark-theme] .e2-h-off{background:#6e6e73}body[data-ds-dark-theme] .e2-confirmbox{background:rgba(0,0,0,.55)}body[data-ds-dark-theme] .e2-badge{color:#e8c97a;background:rgba(232,201,122,.14)}',
