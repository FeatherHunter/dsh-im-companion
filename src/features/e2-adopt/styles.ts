...
export const CSS = [
  ...
  '@media (prefers-color-scheme: dark){.e2-cockpit{--e2-paper:#211d16;--e2-card:rgba(255,253,247,.07);--e2-ink:#f2ece1;--e2-faint:rgba(242,236,225,.55);--e2-line:rgba(242,236,225,.16)}}',
  ...
  '.e2-tape{display:inline-block;background:rgba(200,180,130,.5);padding:1px 12px;font-size:15px;font-weight:800;transform:rotate(-2deg)}',
  '@media (prefers-color-scheme: dark){.e2-tape{background:rgba(200,180,130,.28)}}',
