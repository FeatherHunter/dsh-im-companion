...
export const CSS = [
  ...
  'body[data-ds-dark-theme] .e2-cockpit{--e2-paper:color-mix(in srgb, var(--dsw-alias-bg-base, #201b14) 85%, #c8a75a 15%);--e2-card:color-mix(in srgb, var(--e2-paper) 88%, #fff8ea 12%);--e2-ink:var(--dsw-alias-label-primary, #f4ede1);--e2-faint:var(--dsw-alias-label-secondary, rgba(244,237,225,.68));--e2-line:color-mix(in srgb, var(--e2-paper) 70%, #c8a75a 30%);border:1px solid var(--e2-line);box-shadow:0 24px 80px rgba(0,0,0,.6)}',
  ...
  '.e2-sec-new{cursor:pointer;display:grid;gap:10px;grid-template-columns:repeat(auto-fill,minmax(200px,1fr))}',
