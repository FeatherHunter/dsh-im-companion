...
export const CSS = [
  ...
  '.e2-grid{display:flex;flex-wrap:wrap;gap:16px;align-items:flex-start}',
  '.e2-sec{flex:0 1 auto;width:fit-content;min-width:0;max-width:100%;margin:0;background:var(--e2-card);border-radius:6px;padding:12px 12px 10px;box-shadow:0 4px 16px rgba(90,70,40,.12);color:var(--e2-ink)}',
  '.e2-sec-unbound{flex:1 1 100%;border:1.5px dashed var(--e2-faint);box-shadow:none;background:transparent;min-height:0}',
  ...
  '.e2-foot{flex:1 1 100%;font-size:12px;color:var(--e2-faint);text-align:center;margin-top:2px}',
].join('\n')
